...
public class MainWindow extends JFrame implements ActionListener {
	...
	private static final String CAMBIAR_USUARIO = "cambiarUsuario";
	...
	public MainWindow() {
		...
		btnCambiarUsuario.setBounds(100, 100, 100, 100);
		gbc.gridy = 8;
		btnCambiarUsuario.setActionCommand(CAMBIAR_USUARIO);
		btnCambiarUsuario.addActionListener(this);
		add(btnCambiarUsuario, gbc);
	...
	public void actionPerformed(ActionEvent evento) {
		...
		if (CAMBIAR_USUARIO.equals(comando)) {
			cambiarUsuario();
		}
